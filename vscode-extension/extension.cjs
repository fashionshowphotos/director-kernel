...
const PRODUCT_NAME = 'Director Kernel';
const COMMAND_PREFIX = 'directorKernel';
const CONFIG_NS = 'directorKernel';
const ROOT_SENTINELS = ["package.json","src/cli.ts"];
